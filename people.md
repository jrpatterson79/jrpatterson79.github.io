...
<section class="post">
    ...
    <h1 style="text-align:center; padding-bottom:25px; font-size:3rem">Physical Hydrogeology Research Group</h1>

<h3 class="name-header">Jeremy Patterson</h3>
<img class="bio-img" src="/assets/images/bio_pics/river.jpg" alt="" height="325px" width="230px"/>
<p class="bio-text">  
